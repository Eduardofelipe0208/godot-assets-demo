...
Import the project folder into Godot 4.

Open main.tscn.

Press F5 (Play) to start the simulation.

Demonstration

(Insert a GIF or short video here showing the cubes falling and stacking)

Developed by Eduardo Marcano - Software Engineer & Game Developer
